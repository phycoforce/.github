...
The following is a set of guidelines for contributing to any [phycoforce](https://github.com/phycoforce) repository. Individual repos may add or refine these rules in their own `CONTRIBUTING.md`; in that case, the repo-level guide takes precedence over this one.
...
> [!IMPORTANT]
> Repositories under [phycoforce](https://github.com/phycoforce) do **not** accept pull requests that are fully or predominantly AI-generated. AI tools may be used solely in an assistive capacity.
>
